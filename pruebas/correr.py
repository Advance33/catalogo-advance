...
ORDEN = ['agrupacion', 'portada', 'extras', 'precios', 'color-precio', 'foto-color', 'nombres', 'meta', 'sugeridos', 'destacada', 'carrusel', 'layout']
PRESUPUESTO = {'layout': 200, 'extras': 150, 'foto-color': 150}   # segundos; el resto usa el de correr()
